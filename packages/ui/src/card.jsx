...
const Card = ({ setColor }) => {
  return (
    <div className="mt-3 w-10/12 rounded-2xl border-2 border-black shadow-none pl-2 pr-2 py-1 text-background">
      ...
      <div className="py-1.5 grid grid-cols-4">
        ...
        <div className="my-auto pl-2 text-sm sm:text-base">in %</div>
      </div>
    </div>
  )
}

...
const ColorInput = ({ type, setColor }) => {
  return (
    <input
      className={`mx-2.5 w-10/12 h-10 sm:h-12 rounded-lg shadow-none bg-black border outline-none text-center ${type === "red" ? "border-red-500" : type === "blue" ? "border-blue-500" : "border-green-500"}`}
      type="text"
      pattern="[0-9]*"
      maxLength={3}
      placeholder="0"
